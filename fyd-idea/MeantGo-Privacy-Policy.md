...
19. [Jurisdiction-Specific Provisions](#19-jurisdiction-specific-provisions)
    5.6. [Apple App Privacy Details](#56-apple-app-privacy-details)
...
- We request "while using the app" location access only and do not collect location in the background. If you revoke access, distance-based features will be disabled but the rest of the app will continue to work normally.
...
| **Diagnostics**                   | Basic technical, crash, or performance information where retained in our logs, used to maintain reliability and resolve technical failures.                                                                          |
...
### 5.6 Apple App Privacy Details

For purposes of Apple's App Privacy Details, the categories of information we may collect and the
reasons we use them are summarised below. This summary describes the same practices explained in
this Policy and does not replace the App Store disclosures submitted for a particular app version.

| Apple category      | Examples                                                                                | Purpose                                                     |
| ------------------- | --------------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| Contact Info        | Name, phone number, email address                                                       | App functionality and account management                    |
| Identifiers         | Account identifier, session token, device or push token                                 | App functionality, security, and notifications              |
| User Content        | Bio, interests, relationship intention, lifestyle preferences, family plans, and height | App functionality and product personalisation               |
| Photos or Videos    | Profile photos and video introduction                                                   | Profile display and social discovery                        |
| Precise Location    | GPS coordinates collected with permission while using the app                           | Proximity-based discovery and distance matching             |
| Product Interaction | Screens visited, features used, and session activity                                    | Analytics and app functionality                             |
| Diagnostics         | Basic technical, crash, or performance data where retained in our logs                  | App functionality, reliability, and performance improvement |
| Other Data Types    | Date of birth, gender, and age-verification information                                 | Account creation, profile personalisation, and safety       |

Account, profile, contact, location, device, and account-linked usage information is generally
linked to your account or session. Analytics that have been fully aggregated and anonymised cannot
reasonably be linked to you.

We do not sell personal data, use data for third-party advertising, use cross-app or cross-website
tracking for advertising, or share data with data brokers for those purposes. We share information
only with service providers needed to operate MeantGo, such as SMS verification, push notification,
and cloud storage providers, as described in Section 7.
